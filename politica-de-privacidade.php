...
<body>
    ...
    <section class="politica-privacidade">
        <div class="container">
            ...
            <div class="privacidade-text">
                <p>Ademais, o documento poderá sofrer atualizações decorrentes de eventuais alterações normais, razão pela qual convidamos o usuário a consultar esta seção periodicamente.</p>
            </div>
        </div>
    </section>
    ...
    <section id="LGPD">
        <div class="container">
            <h3 class="font-weight-bold">2 - TRATAMENTO DE DADOS</h3>

            <div class="privacidade-text">
                <p>Os dados pessoais de usuário e visitantes serão coletados, classificados, utilizados, processados e arquivados como condição indispensável para a execução de contratos relativos à contratação dos produtos e serviços da MVNO, mediante a consentimento expresso manifestado no Termo de Adesão aos Serviços, disponível em: <a class="adesao font-weight-bold" href="./termos-de-adesao">Termos de Adesão</a>, e por intermédio das nossas Políticas de Privacidade.</p>
            </div>
            <div class="privacidade-text">
                <p>No âmbito do consentimento para tratamento de dados pessoais, estão incluídos:</p>
            </div>
            <ul class="ml-4">
            ...
            <div class="privacidade-text">
                <p>Os dados pessoais de usuários e visitantes são coletados por meio das seguintes ações:</p>
            </div>

            <strong class="d-block pt-4">Ao criar uma conta/perfil na plataforma da MVNO:</strong>

            <div class="privacidade-text">
                <p>Por meio desta ação são coletados básicos de identificação, como por exemplo: nome do usuário ou visitante, CPF, RG, data de nascimento, telefones, endereço e e-mail. A partir desses dados, podemos identificar o usuário e o visitante, além de garantir uma maior segurança e bem-estar às suas necessidades.</p>
            </div>

            <strong class="d-block pt-4">Ao acessar as páginas da plataforma da MVNO:</strong>

            <div class="privacidade-text">
                <p>Por meio desta ação, as informações sobre interação e acesso são coletadas pela empresa para garantir melhor experiência ao usuário ou visitante. Tais dados podem tratar sobre palavras-chave utilizadas ao realizar busca, comentários, visualização de páginas, perfis, a URL de onde o usuário ou visitante provêm, o navegador utilizado e seus respectivos IPs de acesso, localização, recursos, ofertas contratadas ou pesquisadas, informações fornecidas enquanto utiliza os serviços, duração e frequência das atividades, entre outras informações que poderão ser armazenadas e retidas.</p>
            </div>

            <h3 class="font-weight-bold pt-6">2.2 - QUAIS DADOS COLETAMOS?</h3>

            <div class="privacidade-text">
                <p>Os dados pessoais de usuários e visitantes coletados são os seguintes:</p>
            </div>

            <strong class="d-block pt-4">Dados da criação de conta/perfil no site da MVNO:</strong>

            <div class="privacidade-text">
                <p>Nome do usuário ou visitante, CPF, RG, data de nascimento, telefones, endereço e e-mail.</p>
            </div>

            <strong class="d-block pt-4">Dados para otimização da navegação:</strong>

            <div class="privacidade-text">
                <p>Palavras-chave utilizadas ao realizar uma busca, comentários, visualizações de páginas, perfis, a URL de onde o usuário ou visitante provêm, o navegador utilizado e seus respectivos IPs de acesso, duração e frequência das atividades, localização, recursos, ofertas contratadas ou pesquisadas e informações fornecidas enquanto utiliza os serviços.</p>
            </div>

            <strong class="d-block pt-4">Dados para realização de transações financeiras:</strong>

            <div class="privacidade-text">
                <p>Poderão ser coletados e armazenados dados necessários para concretizar a contratação dos serviços fornecidos por meio do site da MVNO, como número de cartão de crédito, bem como sua data de validade, código de verificação e demais informações relativas aos pagamentos efetuados.</p>
            </div>

            <strong class="d-block pt-4">Dados relacionados a contratos e demais formalizações:</strong>

            <div class="privacidade-text">
                <p>Serão coletados e armazenados dados relativos às execuções contratuais, para cumprimento das formalizações requeridas no processo de contratação dos produtos e serviços oferecidos pela MVNO. De igual modo, eventuais comunicações realizadas entre a empresa supraticada e os usuários também ficarão à disposição de ambas as partes, para dirimir qualquer desacordo perante o que ficou estabelecido no ato de contratação de quaisquer serviços, e que se assegura por meio desse documento.</p>
            </div>

            <h3 class="font-weight-bold pt-6">2.3 - POR QUE REALIZAMOS A COLETA DE DADOS?</h3>

            <div class="privacidade-text">
                <p>Os dados pessoais do usuário e/ou do visitante coletados e armazenados pela MVNO têm por finalidade:</p>
            </div>

            <strong class="d-block pt-4">Bem-estar do usuário e/ou visitante:</strong>

            <div class="privacidade-text">
                <p>Aprimorar os produtos e serviços oferecidos pela MVNO; facilitar, agilizar e cumprir os compromissos estabelecidos entre a MVNO e os usuários de seus produtos e serviços; melhorar a experiência de usuários e visitantes; fornecer funcionalidades específicas aos usuários dos produtos e serviços da MVNO.</p>
            </div>

            <strong class="d-block pt-4">Melhorias da plataforma:</strong>

            <div class="privacidade-text">
                <p>Compreender as facilidades e limitações dos usuários e visitantes no contato com os produtos e serviços oferecidos pela MVNO, com o intuito de ajudar no desenvolvimento de negócios e de novas técnicas.</p>
            </div>

            <strong class="d-block pt-4">Comercial:</strong>

            <div class="privacidade-text">
                <p>Os dados também serão utilizados para personalizar o conteúdo oferecido pela MVNO e gerar subsídio à plataforma, possibilitando a melhoria da qualidade no funcionamento do sistema, bem como de seus produtos e serviços.</p>
            </div>

            <strong class="d-block pt-4">Anúncios:</strong>

            <div class="privacidade-text">
                <p>Apresentar anúncios personalizados aos usuários e visitantes, com base nos dados fornecidos.</p>
            </div>

            <strong class="d-block pt-4">Mapeamento do perfil do usuário e visitante:</strong>

            <div class="privacidade-text">
                <p>Tratamento automatizado de dados pessoais para avaliar o comportamento e mapear os perfis dos usuários e visitantes.</p>
            </div>

            <strong class="d-block pt-4">Dados de Contrato:</strong>

            <div class="privacidade-text">
                <p>Conferir segurança jurídica às partes, com o intuito de facilitar as operações de aquisição dos produtos e serviços oferecidos pela MVNO.</p>
            </div>
            <div class="privacidade-text">
            ...
            <div class="privacidade-text">
                <p>Os dados poderão ser removidos ou anonimizados a pedido do usuário, excetuando os casos em que a lei oferecer outro tratamento.</p>
            </div>
            <div class="privacidade-text">
                <p>Ainda, os dados pessoais dos usuários poderão ser conservados após o término de seu tratamento, apenas nas seguintes hipóteses previstas no artigo nº 16 da referida lei:</p>
            </div>
            <ul class="ml-4" style="list-style: upper-roman;">
            ...
            <div class="privacidade-text">
                <p>Todos os dados pessoais serão armazenados em local seguro e em servidores próprios. É assegurado ao titular, a qualquer momento:</p>
            </div>
            <ul class="ml-4">
            ...
            <div class="privacidade-text">
                <p class="mt-3">Todas as solicitações relativas a tais direitos deverão ser encaminhadas pelo titular diretamente ao controlador e serão atendidas em prazo compatível com a respectiva complexidade técnica, observados os limites impostos pela legislação aplicável.</p>
            </div>
            <div class="privacidade-text">
                <p>Se você tiver uma conta neste site, poderá solicitar um arquivo exportado dos seus dados pessoais, inclusive quaisquer dados que nos tenha fornecido.</p>
            </div>
            <div class="privacidade-text">
                <p>Também poderá solicitar que removamos qualquer dado pessoal armazenado sobre você em nosso sistema. Esta concessão não incluirá nenhum dado de manutenção obrigatória para propósitos administrativos, legais ou de segurança.</p>
            </div>
            <div class="privacidade-text">
                <p>As solicitações deverão ser realizadas na página de contato do site da MVNO: </p>
            </div>
            <div class="privacidade-text">
                <p>A MVNO se compromete a aplicar as medidas técnicas e organizativas aptas a proteger os dados pessoais de acessos não autorizados e de situações de destruição, perda, alteração, comunicação ou difusão de tais dados.</p>
            </div>
            <div class="privacidade-text">
                <p>Dados relativos a cartões de crédito serão sempre criptografados, utilizando a tecnologia "secure socket layer" (SSL), que garante a transmissão de dados de forma segura e confidencial, de modo que a transmissão dos dados entre o servidor e o usuário ocorra de maneira cifrada e encriptada.</p>
            </div>
            <div class="privacidade-text">
            ...
            <div class="privacidade-text">
                <p>Os dados pessoais armazenados serão tratados com confidencialidade, dentro dos limites legais. No entanto, poderemos divulgar suas informações pessoais em caso de exigência legal ou em caso de violação de nossos Termos de Uso.</p>
            </div>
            ...
            <div class="privacidade-text mt-3">
                <p>O compartilhamento de dados do usuário ocorrerá com os dados de usuários mediante autorização determinada a partir da publicação da presente Política de Privacidade.</p>
            </div>

            <h3 class="font-weight-bold pt-6">2.7 - OS DADOS PESSOAIS ARMAZENADOS SERÃO TRANSFERIDOS A TERCEIROS?</h3>

            <div class="privacidade-text mt-3">
                <p>A MVNO e o controlador são responsáveis por sua própria base de dados e podem utilizar as informações dentro do limite e propósito de seu ramo de atuação, mas não respondem pelo tratamento de dados fornecidos a partir de outros meios, como aplicativos, sistemas operacionais, plataformas e publicidade oferecidos por terceiros, ainda que realizadas a partir da página da MVNO, sendo obrigação do titular consultar suas respectivas políticas de privacidade respectivas.</p>
            </div>
            <div class="privacidade-text mt-3">
                <p>Assim, os dados pessoais coletados a partir da página da MVNO poderão ser compartilhados com as seguintes empresas:</p>
            </div>
            <div class="privacidade-text mt-3">
                <p>GOOGLE ANALYTICS - Google Brasil Internet LTDA, inscrita sob o CNPJ nº 06.990.590/0001-23, para coletar informações de navegação do usuário. Sua política de cookies está disponível <a class="adesao" href="https://developers.google.com/analytics/devguides/collection/analyticsjs/cookie-usage?hl=pt-PT">aqui</a>.</p>
            </div>
        </div>
    </section>
    ...
    <section id="cookies">
        <div class="container">
            <h3 class="font-weight-bold">3 - COOKIES OU DADOS DE NAVEGAÇÃO</h3>

            <div class="privacidade-text">
                <p>Informações relativas à navegação no site www.drytelecom.com , como local e horário de acesso, serão enviados pela plataforma ao dispositivo do usuário e/ou visitante - e nele ficarão armazenados - por meio de cookies.</p>
            </div>
            <div class="privacidade-text">
                <p>O usuário e/ou visitante do site www.drytelecom.com manifesta conhecer e aceitar a coleta de dados de navegação realizada mediante a utilização de cookies.</p>
            </div>
            <div class="privacidade-text">
            ...
            <div class="privacidade-text">
                <p>É possível redefinir seu navegador da web para recusar todos os cookies, porém alguns recursos da plataforma poderão não funcionar corretamente caso a funcionalidade de aceitar cookies estiver desabilitada.</p>
            </div>
            <div class="privacidade-text">
                <p>Ao acessar sua conta de usuário no site www.drytelecom.com , os seguintes cookies serão criados e/ou utilizar para melhorar e facilitar a experiência de navegação:</p>
            </div>
            <div class="privacidade-text">
                <p>A MVNO se reserva ao direito de modificar a política de cookies a qualquer momento, informando ao titular por intermédio de banner no site a respeito das alterações e da necessidade de consentimento como condição para a preservação das funcionalidades e navegabilidade do site.</p>
            </div>

            <h3 class="font-weight-bold pt-6">4 - CONSENTIMENTO</h3>

            <div class="privacidade-text">
                <p>Ao utilizar e/ou contratar os serviços oferecidos pela MVNO e fornecer suas informações pessoais na plataforma, o usuário e/ou visitante estará consentindo com os termos descritos na presente Política de Privacidade.</p>
            </div>
            <div class="privacidade-text">
                <p>O usuário, ao cadastrar-se, manifesta conhecê-lo e pode exercitar seus direitos de realizar o cancelamento, acessar e atualizar seus dados pessoais. Nos mesmos termos, o usuário e/ou visitante reconhece e aceita voluntariamente que o serviço será utilizado, em qualquer caso, sob sua única e exclusiva responsabilidade, assumindo o compromisso de fornecer informações cadastrais verdadeiras e atualizadas.</p>
            </div>
            <div class="privacidade-text">
                <p>O usuário, por fim, tem o pleno direito retirar o seu consentimento a qualquer tempo, para tanto deve entrar em contato através do e-mail contato@drytelecom.com.br ou por correio enviado ao seguinte endereço: AV ANÁPOLIS, N° 510 - VILA NILVA - BARUERI/SP - CEP 06404-250</p>
            </div>

            <h3 class="font-weight-bold pt-6">5 - ALTERAÇÕES</h3>

            <div class="privacidade-text">
                <p>Com o intuito de respeitar, em absoluto, a transparência, a integridade das informações que aqui estão apresentadas e eventuais alterações - seja em decorrência de mudanças no site da MVNO, nos sites a ele associados, utilização de novas tecnologias, cumprimento da legislação aplicável ou sempre que a MVNO julgar necessário - reservamos o direito de modificar nossa Política de Privacidade a qualquer momento. Assim, recomendamos aos usuários e visitantes que busquem revisitar este documento regularmente, para acompanhar possíveis alterações em seu texto original.</p>
            </div>
            <div class="privacidade-text">
                <p>Ademais, alterações e possíveis esclarecimentos surtirão efeito imediatamente após sua publicação no site da MVNO. Deste modo, todos os usuários serão notificados em caso de alteração. Ao utilizar nossos serviços ou fornecer informações pessoais em período posterior às eventuais modificações, os usuários e visitantes atestam concordar com as novas normas.</p>
            </div>
            <div class="privacidade-text">
                <p>Diante da fusão ou venda da plataforma à outra empresa, os dados dos usuários poderão ser transferidos para os novos proprietários, garantindo que a permanência dos serviços oferecidos seja plenamente assegurada.</p>
            </div>

            <h3 class="font-weight-bold pt-6">6 - JURISDIÇÃO PARA RESOLUÇÃO DE CONFLITOS</h3>

            <div class="privacidade-text">
                <p>Para resolução efetiva de eventuais desacordos ou controvérsias decorrentes da presente Política de Privacidade, será aplicado integralmente o Direito Brasileiro.</p>
            </div>
            <div class="privacidade-text">
                <p>Eventuais litígios deverão ser apresentados no foro da comarca em que encontra-se sediada a empresa responsável por este instrumento.</p>
            </div>
        </div>
    </section>
            ...
            <div class="row pt-5">
                <div class="col-md-4 align-center-vertical mx-auto">
                    ...
                    <div class="align-self-center">
                        <button class="btn-padrao borda-botao btn-menor" style="min-width: 140px;" data-toggle="modal" data-target="#modalContato">CONTATO</button>
                    </div>
                </div>
            </div>
            <div class="row">
